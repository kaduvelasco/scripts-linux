...
# Baixa o arquivo php82.ini do repositório GitHub e substitui o existente
echo "⬇️ Baixando e substituindo o php.ini..."
curl -o /etc/php/8.2/fpm/php.ini https://github.com/kaduvelasco/scripts-linux/raw/main/php-ini/php82.ini
