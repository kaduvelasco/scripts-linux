...
# Baixa o arquivo php74.ini do repositório GitHub e substitui o existente
echo "⬇️ Baixando e substituindo o php.ini..."
curl -o /etc/php/7.4/fpm/php.ini https://github.com/kaduvelasco/scripts-linux/raw/main/php-ini/php74.ini
